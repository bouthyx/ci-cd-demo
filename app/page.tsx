export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-rose-800 via-pink-800 to-rose-800 flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        ...
        <header className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-rose-500/20 backdrop-blur-sm border border-rose-500/30 rounded-full px-6 py-2 mb-8">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            <span className="text-rose-200 text-sm font-medium">Live CI/CD Pipeline</span>
          </div>

          <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white via-rose-200 to-pink-200 bg-clip-text text-transparent mb-6">
            DevOps Pipeline Boudad Aya
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-rose-200 mb-6">
        ...
        <section className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300">
            <div className="w-12 h-12 bg-gradient-to-br from-rose-400 to-rose-600 rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300">
            <div className="w-12 h-12 bg-gradient-to-br from-rose-400 to-pink-600 rounded-xl flex items-center justify-center mb-4">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <section className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-pink-500 rounded-full flex items-center justify-center mx-auto mb-3 animate-spin">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
              ...
              <p className="text-pink-200 text-sm">In Progress</p>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {["Next.js", "Jenkins", "Docker", "Tailwind CSS", "GitHub Actions", "AWS"].map((tech) => (
              <div key={tech} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-6 py-3">
                <span className="text-rose-100 font-medium">{tech}</span>
              </div>
            ))}
          </div>
        </section>
      ...
      <footer className="absolute bottom-6 text-center text-pink-200 text-sm">
